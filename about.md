...
**2006.** — Amar-ze pita na forumu: *"Šta ima kod nas Zeničani? Dešava li se išta?"* Gomez odgovara sa ambicioznim planovima — besplatni kursevi na Mašinskom fakultetu, radionice, novi domen `glugzdk.ba`. Snimljena **profesionalna TV reklama** za Linux seminar. AbsintheSyringe je opisao reklamu kao *"Totalno totalno kul. Profesionalno 100%."* Prva radionica zakazana za 3. juni na Mašinskom fakultetu.

**2007.** — Gomezov legendarni izvještaj sa sastanka u Zenici: *"Na ulicama se moglo vidjeti dosta mladih, lijepih i atraktivnih djevojaka sa kućnim ljubimcima..."* — a LugZe ekipa sa svojim "kućnim ljubimcima" (miševi, mačke, pingvini) ide na radni sastanak. Mesa, Sale i RiNG — old school postava.

**2008.** — Na forumu tesnjak pita da li se u Zenici uopšte koristi Linux. ShereKhan dijeli priču kako ga je gomez konvertovao na Ubuntu: *"Gomez ima barem 50% zasluge u 'konvertovanju' mene na Ubuntu. Kad se sjetim, bila je to tragedija u kući kada je mali brat skontao da je Windows otišao iz kuće i da se neće više vratiti :)"* Gomez dodaje: *"Ovo je primjer da se Linuxom može i sevapa zaraditi."*
...
**21. maj 2003.** — Dva LugZe člana na Mašinskom fakultetu u Zenici. Jedan u crnoj Debian majici, drugi u bijeloj sa Tux pingvinom i natpisom „Linux Korisnik Zenice". Razmjenjuju knjige u hodniku fakulteta — rani dani zajednice, kad se open-source znanje dijelilo iz ruke u ruku. 🐧

![LugZe članovi na Mašinskom fakultetu, 21.05.2003.]({{ site.url }}/blog/assets/images/meetups/lugze_2003.jpeg)

**21. maj 2003.** — Šest LugZe članova ispred kafića u Zenici nakon druženja. U prvom planu prepoznatljiva crna Debian majica, iza natpis „Caffe" i vinova loza. Večernja atmosfera — osmijesi, piva (ili ne, kako gomez kaže — *"nastojimo živjeti zdravo"*) i zajedništvo koje je držalo ovu ekipu na okupu. ☕

![LugZe ekipa ispred kafića, 21.05.2003.]({{ site.url }}/blog/assets/images/meetups/lugze_sastanak_2003_godina.jpg)

**2017.** — Pet članova u modernom coworking prostoru na ZeForge meetupu. Zeleni stubovi, veliki prozori, isti entuzijazam. Od Debian majica do poslovnih košulja — prošlo je 14 godina, ali LugZe duh je ostao isti. 💚
...
- 🥇 **Prvi Linux seminar u BiH** — Bosansko narodno pozorište, Zenica, 28. novembar 2004.
- 🌐 **Mozilla na bosanskom** — ~9.000 stringova, zvanično na mozilla.org
- 📝 **Provjera pravopisa** za bosanski jezik
- 🎬 **TV reklama** za Linux seminar — *"Totalno totalno kul. Profesionalno 100%"*
- 🏫 **Linux u školama** — 15 računara sa Mandrake 9.0 u zeničkoj gimnaziji
- 📚 **Besplatni kursevi** na Mašinskom fakultetu
- 🤝 **Saradnja sa ULK** (Unija Linux Korisnika)
- 💻 **Blog sa tutorijalima** — Linux, Ruby, shell, /proc, sysfs i ostalo
- ☕ **Linux kafa** — WhatsApp grupa koja i dalje živi
...
- 🏛️ [Arhiva starog sajta](https://github.com/lugze/archive/tree/master)
...
*🐧 uptime — since 2002. I dalje se nastoji živjeti zdravo.*
